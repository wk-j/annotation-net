...
Public Class Annotations
    ...
    ''' <summary>
    ''' Adds text annotation in Slides document
    ''' </summary>
    Public Shared Sub AddTextAnnotationSlides()
        Try
            'ExStart:AddTextAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddAreaAnnotationWithRepliesSlides()
        Try
            'ExStart:AddAreaAnnotationWithReplies
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds point annotation in Slides document
    ''' </summary>
    Public Shared Sub AddPointAnnotationSlides()
        Try
            'ExStart:AddPointAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds text strikeout annotation in Slides document
    ''' </summary>
    Public Shared Sub AddTextStrikeOutAnnotationSlides()
        Try
            'ExStart:AddTextStrikeOutAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds polyline annotation in Slides document
    ''' </summary>
    Public Shared Sub AddPolylineAnnotationSlides()
        Try
            'ExStart:AddPolylineAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds text field annotation in Slides document
    ''' </summary>
    Public Shared Sub AddTextFieldAnnotationSlides()
        Try
            'ExStart:AddTextFieldAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds watermark annotation in Slides document
    ''' </summary>
    Public Shared Sub AddWatermarkAnnotationSlides()
        Try
            'ExStart:AddWatermarkAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds text replacement annotation in Slides document
    ''' </summary>
    Public Shared Sub AddTextReplacementAnnotationSlides()
        Try
    ...
    ''' <summary>
    ''' Adds arrow annotation in Slides document
    ''' </summary>
    Public Shared Sub AddArrowAnnotationSlides()
        Try
            'ExStart:AddArrowAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds text redaction annotation in Slides document
    ''' </summary>
    Public Shared Sub AddTextRedactionAnnotationSlides()
        Try
            'ExStart:AddTextRedactionAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds underline annotation in Slides document
    ''' </summary>
    Public Shared Sub AddUnderLineAnnotationSlides()
        Try
            'ExStart:AddUnderLineAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds distance annotation in Slides document
    ''' </summary>
    Public Shared Sub AddDistanceAnnotationSlides()
        Try
            'ExStart:AddDistanceAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Adds resource redaction annotation in Slides document
    ''' </summary>
    Public Shared Sub AddResourceRedactionAnnotationSlides()
        Try
            'ExStart:AddResourceRedactionAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' <summary>
    ''' Removes all annotations in Slides document
    ''' </summary>
    Public Shared Sub RemoveAllAnnotationsFromDocumentSlides()
        ...
        Try
            ...
            ' Save result stream to file.
            Using fileStream As New FileStream(CommonUtilities.MapDestinationFilePath("Annotated.Slides"), FileMode.Create)
                Dim buffer As Byte() = New Byte(result.Length - 1) {}
                result.Seek(0, SeekOrigin.Begin)
                result.Read(buffer, 0, buffer.Length)
                fileStream.Write(buffer, 0, buffer.Length)
    ...
    ''' </summary>
    Public Shared Sub AddTextAnnotationImages()
        Try
            'ExStart:AddTextAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddAreaAnnotationWithRepliesImages()
        Try
            'ExStart:AddAreaAnnotationWithReplies
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddPointAnnotationImages()
        Try
            'ExStart:AddPointAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddTextStrikeOutAnnotationImages()
        Try
            'ExStart:AddTextStrikeOutAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddPolylineAnnotationImages()
        Try
            'ExStart:AddPolylineAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddTextFieldAnnotationImages()
        Try
            'ExStart:AddTextFieldAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddWatermarkAnnotationImages()
        Try
            'ExStart:AddWatermarkAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddTextReplacementAnnotationImages()
        Try
    ...
    ''' </summary>
    Public Shared Sub AddArrowAnnotationImages()
        Try
            'ExStart:AddArrowAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddTextRedactionAnnotationImages()
        Try
            'ExStart:AddTextRedactionAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddUnderLineAnnotationImages()
        Try
            'ExStart:AddUnderLineAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddDistanceAnnotationImages()
        Try
            'ExStart:AddDistanceAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub AddResourceRedactionAnnotationImages()
        Try
            'ExStart:AddResourceRedactionAnnotation
            ' Get input file stream
            Dim inputFile As Stream = New FileStream(CommonUtilities.MapSourceFilePath(filePath), FileMode.Open, FileAccess.ReadWrite)
    ...
    ''' </summary>
    Public Shared Sub RemoveAllAnnotationsFromDocumentImages()
        ...
        Try
            ...
            ' Get output file stream
            Dim result As Stream = annotator.RemoveAnnotationStream(inputFile, DocumentType.Images)

            ' Save result stream to file.
            Using fileStream As New FileStream(CommonUtilities.MapDestinationFilePath("Annotated.png"), FileMode.Create)
                Dim buffer As Byte() = New Byte(result.Length - 1) {}
                result.Seek(0, SeekOrigin.Begin)
                result.Read(buffer, 0, buffer.Length)
                fileStream.Write(buffer, 0, buffer.Length)

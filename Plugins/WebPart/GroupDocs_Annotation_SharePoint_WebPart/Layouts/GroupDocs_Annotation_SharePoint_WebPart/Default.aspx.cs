...
using GroupDocs_Annotation_SharePoint_WebPart.BusinessLogic.Responses;
...
namespace GroupDocs_Annotation_SharePoint_WebPart
{
    public partial class Default : LayoutsPageBase
    {
        ...
        {
            var filePath = pathFinder.GetApplicationPath() + "_layouts/15/GroupDocs_Annotation_SharePoint_WebPart/App_Data/" + path;

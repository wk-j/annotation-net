    ...
    $.extend(window.groupdocs.groupdocsViewerViewModel.prototype, {
            ...
            var viewerAdapter = this.viewerAdapter = new DocViewerAdapter(
                {
                    ...
                    zoomingOptions: { createHtml: true, _mode:"webComponent" },
        ...
        _downloadDocument: function () {
            ...
            if (downloadUrl == null) {
                ...
                downloadUrl = this.applicationPath + '/GetFile' + urlSuff + '?path=' + this.filePath + '&getPdf=false&useHtmlBasedEngine=false&supportPageRotation=false';
            }
